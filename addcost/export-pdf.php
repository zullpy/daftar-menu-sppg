...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .info-table td { border: none; padding: 2px 4px; font-size: 8.5pt; line-height: 1.4; }
        .info-table .label { width: 1%; white-space: nowrap; padding-right: 2px; }
        .info-table .label-right { width: 1%; white-space: nowrap; padding-left: 12px; padding-right: 2px; }
        .info-table .value { padding-left: 4px; }
...
<body>
    ...
    <div class="page-wrap">
        <table class="header-table">
            <tr>
                <td class="col-logo"><img src="../assets/logo.png" alt="Logo KBUS" width="100" height="100"></td>
                <td class="col-kop">
